...
const _native_User_is_logged_in = nativeModule.User_is_logged_in;
...
class User extends SyncUser {
  ...
  subscribe(observer) {
    return _native_User_subscribe(this[_SyncUser_Symbol], observer);
  }
  unsubscribe(token) {
    return _native_User_unsubscribe(this[_SyncUser_Symbol], token);
  }
  pathForRealm(config, custom_file_name) {
    return _native_User_path_for_realm(this[_SyncUser_Symbol], config, custom_file_name);
  }
  accessTokenRefreshRequired() {
    return _native_User_access_token_refresh_required(this[_SyncUser_Symbol]);
  }
  requestRefreshLocation() {
    return _promisify(false, _cb => _native_User_request_refresh_location(this[_SyncUser_Symbol], _cb));
  }
  requestAccessToken() {
    return _promisify(false, _cb => _native_User_request_access_token(this[_SyncUser_Symbol], _cb));
  }
  trackRealm(path) {
    return _native_User_track_realm(this[_SyncUser_Symbol], path);
  }
  get isLoggedIn() {
    return _native_User_is_logged_in(this[_SyncUser_Symbol]);
  }
  get userId() {
    return _native_User_user_id(this[_SyncUser_Symbol]);
  }
  get appId() {
    return _native_User_app_id(this[_SyncUser_Symbol]);
  }
  get legacyIdentities() {
    return _native_User_legacy_identities(this[_SyncUser_Symbol]);
  }
  get accessToken() {
    return _native_User_access_token(this[_SyncUser_Symbol]);
  }
  get refreshToken() {
    return _native_User_refresh_token(this[_SyncUser_Symbol]);
  }
  get state() {
    return _native_User_state(this[_SyncUser_Symbol]);
  }
  get deviceId() {
    return _native_User_device_id(this[_SyncUser_Symbol]);
  }
  get hasDeviceId() {
    return _native_User_has_device_id(this[_SyncUser_Symbol]);
  }
  get userProfile() {
    return _native_User_user_profile(this[_SyncUser_Symbol]);
  }
  get identities() {
    return _native_User_identities(this[_SyncUser_Symbol]);
  }
  get customData() {
    return _native_User_custom_data(this[_SyncUser_Symbol]);
  }
  get app() {
    return _native_User_app(this[_SyncUser_Symbol]);
  }
}
exports.User = User;
