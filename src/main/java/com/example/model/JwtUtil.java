...
public class JwtUtil {
    ...
    private String SECRET_KEY = "secret"; // This should be in a secure place and not hardcoded
    ...
    private Claims extractAllClaims(String token) {
        ...
        return Jwts.parser()
                ...
                .getPayload();
        //return (Claims) Jwts.parser().verifyWith((SecretKey) key).build().parseSignedClaims(token);
    }
